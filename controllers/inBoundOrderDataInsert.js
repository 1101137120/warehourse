...
exports.postInBoundOrders = function(req, res,next) {
	...
	{
		var sql = "INSERT INTO inboundorder (date,time,workId,state,isDelete,remarks,updateTime) VALUES (?,?,?,?,?,?,?);";
		inBoundOrderInstance.query(sql,myQueryArray,function(err, rows, fields) {
			if(err) 
			{
