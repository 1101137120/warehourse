...
exports.postOutBoundOrders = function(req, res,next) {
	...
	{
		var sql = "SELECT id,CASE state WHEN 0 THEN 'error' WHEN 1 THEN 'undone' WHEN 2 THEN 'done' End as state FROM outboundorder where date = '"+date+"' AND workerId = "+wId+" AND workerId = 1 ;";
		console.log(sql);
