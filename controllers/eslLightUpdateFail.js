...
exports.postEsls = function(req, res,next) {
	...
	else
	{
		...
		var sql = "UPDATE esl SET esl.failCount = esl.failCount +1 WHERE id ='"+eslID+"'; UPDATE esl SET esl.remarks = '更新失敗' WHERE esl.failCount =  3;";
		//var sql = "SELECT * FROM esl"
