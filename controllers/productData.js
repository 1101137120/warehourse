...
exports.getProducts = function(req, res,next) {
	...
	console.log("reqfilesssssssssssssss");
	...
	else
	{
		...
		var sql = "select id,eslID,product.name,price,shelf,remarks,inStock as inStocknow from product WHERE product.isDelete = 0;"
