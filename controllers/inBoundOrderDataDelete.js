...
exports.postInBoundOrders = function(req, res,next) {
	...
	{
		var sql = "UPDATE inboundorder SET isDelete = 1,updateTime = '"+updateTime+"' WHERE "+sqlwhere+";";
		console.log("sql  :"+sql);
		inBoundOrderInstance.query(sql,function(err, rows, fields) {
			...
			else
			{
					...
					var sql = "UPDATE inbound_detail SET isDelete = 1,updateTime = '"+updateTime+"' WHERE inboundId = '"+orderID+"' and isDelete = 0;";
